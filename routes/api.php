...
Route::put('/customers/update/{customerId}', 'CustomerController@update')->name('customers.update');
Route::delete('/customers/delete/{customerId}', 'CustomerController@destroy')->name('customers.destroy');